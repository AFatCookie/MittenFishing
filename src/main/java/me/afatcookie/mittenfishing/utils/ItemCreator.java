...
public class ItemCreator {
    ...
    /**
     * creates the sections needed for ItemCreator configuration files
     * @param reloadConfig if files should be created/reloaded
     */
    public ItemCreator(boolean reloadConfig){
        if (reloadConfig) {
            FileConfiguration itemConfig = MittenFishing.getInstance().getConfig();
            itemConfig.addDefault("server.items", "remove this and fill in below");
